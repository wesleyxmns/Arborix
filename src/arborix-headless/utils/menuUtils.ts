import { TreeNodeId, TreeData, TreeNode, ContextMenuItem, ContextMenuOptions } from '../types';
import { UseTreeClipboardResult } from '../../arborix/hooks/useTreeClipboard';
import { ContextMenuIcons } from '../components/ContextMenu';

// ============================================================================
// Menu Utils
// Logic for generating context menu items
// ============================================================================
...
interface GetContextMenuItemsParams {
  ...
  customItems?: (node: TreeNode) => ContextMenuItem[];
}
...
export const getContextMenuItems = ({
  ...
  if (defaults.duplicate) {
    items.push({
      ...
      icon: ContextMenuIcons.Copy, // Using Copy icon for Duplicate as fallback or specific one if available
